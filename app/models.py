...
class UserSession(Base):
    ...
    __table_args__ = (
        Index('idx_session_user_active', 'user_id', 'last_activity'),
    )
...
class ContentItem(Base):
    ...
    __table_args__ = (
        Index('idx_content_type_published', 'content_type', 'is_published', 'created_at'),
...
class UserInterestProfile(Base):
    ...
    preferred_content_length = Column(String(50), nullable=True)  # 'short', 'medium', 'long'

...
- [x] Images must have alternate text: Add alt attributes to all img tags (✅ Completed - logo has alt text)
...
- [x] Remove unsupported 'font-size-adjust' CSS property (✅ Not found in codebase - false positive)
- [x] Fix 'min-height: auto' for Firefox 22+ compatibility (✅ Not found in codebase - false positive)
- [x] Move 'charset' meta element to be first thing in '<head>' (✅ Completed 2025-12-01)

### Performance Issues (MEDIUM PRIORITY)
- [x] Add 'cache-control' header to nginx config (✅ Completed - 7d for static files)
...
- [x] Remove unneeded 'x-xss-protection' header from nginx (✅ Completed - replaced with CSP)
...
- [x] Replace 'X-Frame-Options' with 'Content-Security-Policy: frame-ancestors' (✅ Completed 2025-12-01)
...
- [x] Add ESC key handler to close modal (✅ Already implemented)
- [x] Fix body scroll lock when modal opens (✅ Completed - Fire TV bug fix)
...
- [x] Hamburger menu positioned on far right of header (✅ Completed 2025-12-01)

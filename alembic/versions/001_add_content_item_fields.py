...
def upgrade():
    ...
    op.add_column('content_items', sa.Column('title', sa.String(length=500), nullable=True))
    op.add_column('content_items', sa.Column('description', sa.Text(), nullable=True))
    op.add_column('content_items', sa.Column('category', sa.String(length=100), nullable=True))
    op.add_column('content_items', sa.Column('tags', postgresql.JSON(astext_type=sa.Text()), nullable=True))

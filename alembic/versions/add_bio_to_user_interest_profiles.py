...
def upgrade():
    op.add_column(
        "user_interest_profiles", sa.Column("bio", sa.String(length=500), nullable=True)
    )
    op.add_column(
    ...
    op.add_column(
        "user_interest_profiles", sa.Column("social_links", sa.JSON(), nullable=True)
    )
    op.add_column(
        "user_interest_profiles", sa.Column("expertise", sa.JSON(), nullable=True)
    )
